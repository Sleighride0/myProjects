...
public class Exercise07_StoreHours {
    ...
    public boolean isStoreOpen(int currentHour, char currentDay) {
        if ((currentHour > 7 && currentHour < 17) && (currentDay == 'M')) {
            return true;
        } else if ((currentHour > 7 && currentHour < 17) && (currentDay == 'W')) {
            return true;
        } else if ((currentHour > 7 && currentHour < 17) && (currentDay == 'F')) {
            return true;
        } else return false;
    ...
    public boolean isStoreOpen(int currentHour, char currentDay, boolean isSummer) {
        if ((currentHour > 7 && currentHour < 17) && (currentDay == 'M')) {
            ...
            return true;
        } else if (((currentHour > 7 && currentHour < 20) && (currentDay == 'W')) && (isSummer == true)) {
            return true;
        } else if (((currentHour > 8 && currentHour < 14) && (currentDay == 'S')) && (isSummer == true)) {
            return true;
        } else return false;
    }
}
