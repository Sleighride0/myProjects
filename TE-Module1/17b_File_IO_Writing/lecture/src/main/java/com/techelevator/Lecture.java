...
public class Lecture {
	...
	public static void main(String[] args) throws IOException {
		...
		File mittensJournal = new File("mittensJournal.txt");
		...
		try(Scanner inputScanner = new Scanner(file); PrintWriter writer = new PrintWriter(mittensJournal)) {
			...
			while (inputScanner.hasNextLine()) {
				...
				if (currentLine.contains("Hook")) {
					writer.println(currentLine = currentLine.replaceAll("Hook", "Mittens"));
					//currentLine = currentLine.replaceAll("Hook", "Mittens");
