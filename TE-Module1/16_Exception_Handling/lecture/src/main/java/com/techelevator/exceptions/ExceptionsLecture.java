...
public class ExceptionsLecture {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//exception below caused everything after to not happen
		...
		while (true) {
			try {
				System.out.println("How manh hours did you work last week: ");
				String hours = scan.nextLine();
				int hoursWorked = Integer.parseInt(hours);
				int standardWorkWeekHours = 40;
				int overtimesHours = hoursWorked - 40;
				System.out.println("You worked " + overtimesHours + " overtime hours last week.");
				break;
	...
	public boolean endsLy(String str){
		...
		if(str.substring(str.length()-3).equalsIgnoreCase("ly")){
			return true;
		}
	} return false;
}
