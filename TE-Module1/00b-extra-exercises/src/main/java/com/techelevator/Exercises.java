...
public class Exercises {
    ...
    */
    public int[] arrayDeduplication(int[] nums) {
        ...
        int[] noDuplicates = new int [nums.length - countOfDuplicates];
        for (int i = 0; i <nums.length; i++){
            int valueToAdd = nums[i];
            for(int j = i + 1; j < nums.length; j++){
                boolean match = nums[i] == nums [j];
                if (match != true){
    ...
    */
    public int[] arrayIntersection(int[] a, int[] b) {
        int matchCount = 0;
        // this loop tells me the size of the new array
        ...
        int[] bothArrays = new int[matchCount];
        // this loop compares both arrays to find the match and add to the new array
        for (int i = 0; i < a.length; i++) {
    ...
    */
    public int[] arraySort(int[] nums) {
        ...
        for (int i = 0; i < nums.length; i++) {
            ...
            newArray[nums.length-compareCount] = nums[i];
        }
    ...
    */
    public int blackjack(int a, int b) {
        //check value of 21-a and 21-b return the lower number, return 0 if both over 21
        if (a > 21 && b > 21){
            return  0;
        }
        if(b > 21){
