<template>
  <header class="flex">
    ...
    <div class="actions">
      <button class="btn-edit"
        v-on:click="$router.push({ name: 'EditTopicView', params: { topicId: topicId } })">Edit</button>
  ...
  <div class="flex">
    <h2>Messages</h2>
    <button class="btn-add" v-on:click="$router.push({ name: 'AddMessageView', params: { topicId: topic.id } })">Add
      Message</button>
  </div>
