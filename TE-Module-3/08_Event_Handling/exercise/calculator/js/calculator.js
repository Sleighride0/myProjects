...
document.addEventListener('DOMContentLoaded', () => {
  ...
  decimalRef.addEventListener('click', (event) => {
  ...
  const clearRef = document.querySelector('.all-clear');
  clearRef.addEventListener('click', (event) => {
    clear(event)
  })

// get a reference to all of the operators;
const opRef = document.querySelectorAll('.operator')
...
const equalRef = document.querySelector('.equal-sign');
equalRef.addEventListener('click', (event) =>{
