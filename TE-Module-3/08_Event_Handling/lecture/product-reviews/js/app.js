...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const addReviewRef = document.getElementById('btnToggleForm')
  addReviewRef.addEventListener('click', (event)=>{
      showHideForm();
  })

  const saveReviewButtonRef = document.getElementById('btnSaveReview');
  saveReviewButtonRef.addEventListener('click', (event)=>{
