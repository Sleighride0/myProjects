<template>
  <table id="tblUsers">
    ...
    <tbody>
      <tr>
        <td><input type="text" id="firstNameFilter" v-model.trim="search.firstName" /></td>
        <td><input type="text" id="lastNameFilter" v-model.trim="search.lastName" /></td>
        <td><input type="text" id="usernameFilter" v-model.trim="search.username" /></td>
        <td><input type="text" id="emailFilter" v-model.trim="search.emailAddress" /></td>
        <td>
          <select id="statusFilter" v-model.trim="search.status">
      ...
      <tr v-for="user in users" v-bind:key="user.firstName" :class="{ 'inactive': user.status === 'Inactive' }">
