  ...
  <div class="main">
    ...
    <form v-on:submit.prevent="addNewReview" v-if="showForm">
      ...
      <div class="form=element">
        ...
        <input for="text" id="titleInput" v-model="newReview.title">
      </div>
      <div class="form-element">
    ...
    <div class="review" v-bind:class="{ favorited: review.favorited }" v-for="review in filterReviews" v-bind:key="review.id">
  ...
  methods: {
    ...
    resetForm() {
      this.newReview = {
        ...
        /* we made an empty review which cleared all fields in the form.
        */
        favorited: false
      }
      this.showForm = false;
