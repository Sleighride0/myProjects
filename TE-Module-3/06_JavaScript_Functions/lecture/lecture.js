...
/**
 * takes details on user and joins arguments and elements from listOfQuirks
 * 
 * @param {string} name  user full name
 * @param {number} age age of person in dog years
 * @param {string[]} listOfQuirks list of funny quirks
 * @param {string} separator string used to join together elements from list of quirks
...
function sumAllNumbers(numbersToSum) {
  ...
  //need the return statement when in the curly brackets
}
