INSERT INTO quiz(title, user_id) VALUES ('quiz 1', (SELECT user_id FROM quiz_user WHERE username = 'aaron'));
INSERT INTO quiz(title, user_id) VALUES ('quiz 2', (SELECT user_id FROM quiz_user WHERE username = 'aaron'));
