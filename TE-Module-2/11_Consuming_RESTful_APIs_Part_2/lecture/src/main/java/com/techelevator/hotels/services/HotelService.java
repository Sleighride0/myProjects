...
public class HotelService {
    ...
    public Reservation addReservation(Reservation newReservation) {
        getEntity(newReservation);

        Reservation reservation = null;

        try{
            reservation = restTemplate.postForObject(API_BASE_URL + "reservations", getEntity(newReservation), Reservation.class);
    ...
    public Hotel[] listHotels() {
        Hotel[] hotels = null;
        try {
            // i want to make this request to this location, then how I want to map the response(Hotel[].class)
